...
camera.on('exit', function (timestamp) {
  ...
  var command = 'avconv -y -i /data/vid.264 -s ' + (process.env.VIDEO_FRAMERATE || 15) + ' -vf scale=' + (process.env.VIDEO_WIDTH || 480) + ':' + (process.env.VIDEO_HEIGHT || 270) + ',format=rgb8,format=rgb24 -r 10 /data/vid.gif';
  console.log(command);
